...
class MultipleValidations(Message[Literal["title", "name"]]):
    """
    ```proto
...
class TestOneofMsg(Message[Literal["val"]]):
    """
    ```proto
...
class Oneof(Message[Literal["x", "y", "z"]]):
    """
    ```proto
...
class ProtovalidateOneof(Message[Literal["a", "b", "unrelated"]]):
    """
    ```proto
...
class ProtovalidateOneofRequired(Message[Literal["a", "b", "unrelated"]]):
    """
    ```proto
...
class ProtovalidateOneofUnknownFieldName(Message[Literal["a", "b", "unrelated"]]):
    """
    ```proto
...
class InvalidRESyntax(Message[Literal["value"]]):
    """
    ```proto
...
class ConcatenatedValues(Message[Literal["bar", "baz"]]):
    """
    ```proto
